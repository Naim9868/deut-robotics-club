...
const Blog: React.FC = () => {
  ...
  return (
    <div id="blog" className="py-12 sm:py-16 md:py-20 lg:py-32 bg-background overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal animation="up">
          <div className="mb-8 sm:mb-10 md:mb-14 lg:mb-20">
            ...
            <p className="text-muted uppercase text-[10px] sm:text-xs font-bold tracking-[0.2em] sm:tracking-[0.4em] text-center sm:text-left">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5 lg:gap-6">
          {posts.map((post, i) => (
            <ScrollReveal key={i} animation="up" delay={i * 100}>
              <div className="group flex flex-col h-full bg-card border border-border rounded-xl sm:rounded-2xl overflow-hidden hover:border-primary/50 transition-all duration-500 shadow-2xl hover:shadow-[0_0_30px_rgba(230,57,70,0.1)] hover:-translate-y-1 sm:hover:-translate-y-2">
                ...
                <div className="p-3 sm:p-4 md:p-5 lg:p-8 flex flex-col flex-1">
                  <span className="text-[8px] sm:text-[9px] md:text-[10px] text-muted font-bold uppercase tracking-widest mb-1.5 sm:mb-2 md:mb-3 line-clamp-1">
                    <span>• </span>
                  ...
                  <h3 className="text-xs sm:text-sm md:text-base lg:text-xl font-bold uppercase text-foreground mb-1.5 sm:mb-2 md:mb-3 lg:mb-4 group-hover:text-primary transition-colors leading-tight line-clamp-2 sm:line-clamp-2 md:line-clamp-3">
                    {post.title}
                  </h3>
                  
                  <p className="text-muted text-[10px] sm:text-xs md:text-sm leading-relaxed mb-3 sm:mb-4 md:mb-5 lg:mb-6 flex-1 line-clamp-3 sm:line-clamp-3 md:line-clamp-4">
                    {post.excerpt}
                  </p>

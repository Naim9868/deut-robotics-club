  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-foreground">Contact Messages</h1>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-muted bg-background/5 border border-border rounded-lg hover:bg-background/10 hover:text-foreground transition-colors"
        >
      ...
      {settingsOpen && (
        <div className="bg-card border border-border rounded-xl p-6">
          <h3 className="text-sm font-black text-foreground uppercase tracking-wider mb-4">Reply Settings</h3>
          ...
          <div className="flex justify-end gap-3 mt-4">
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-muted bg-background/5 rounded-lg hover:bg-background/10 transition-colors"
            >
              Cancel
            </button>
            <button
                ...
                <tr>
                  <th className="px-4 py-3 text-left">
                    <input
                      ...
                      className="rounded border-border bg-input-bg accent-primary"
                    />
                  </th>
                  {[
                    { key: 'name', label: 'From' },
              ...
              <tbody className="divide-y divide-border">
                {messages.map((msg) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div>
                        <p className={`text-sm ${msg.status === 'unread' ? 'font-bold text-foreground' : 'text-muted'}`}>
                          {msg.name}
                        </p>
                    ...
                    <td className="px-4 py-3">
                      <p className={`text-sm ${msg.status === 'unread' ? 'font-semibold text-foreground' : 'text-muted'} truncate max-w-[200px]`}>
                        {msg.subject}
                      </p>
                    </td>
                    <td className="px-4 py-3">

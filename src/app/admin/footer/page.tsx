...
export default function FooterPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-white">Footer</h1>
      ...
      {footer && (
        <div className="bg-[#0a0a0a] border border-white/5 rounded-2xl p-4 sm:p-6 lg:p-8">
          ...
          <div className="bg-[#080808] p-4 sm:p-6 rounded-xl">
            <p className="text-gray-400">{footer.description}</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 mt-6 text-sm">
              <div>
